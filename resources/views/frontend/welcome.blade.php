        ...
        <style>
            ...
            *,
            ...
            .transition {
                ...
                transition-property: color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, backdrop-filter, -webkit-backdroresources/views/welcome.blade.phpp-filter;
